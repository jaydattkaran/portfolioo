  ...
  return (
    ...
    >
      ...
      <a href="#hero" aria-label="Logo" className="z-50">
        ...
        <svg width="150" height="45" viewBox="0 0 344 116" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          <path d="M6.06818 93V23.1818H20.8295V53.9659H21.75L46.875 23.1818H64.5682L38.6591 54.4432L64.875 93H47.2159L28.0909 64.2955L20.8295 73.1591V93H6.06818Z" fill="currentColor" />
          <path d="M95.2179 22H109.782L138 94H120.25L102.045 45.5L90.2115 79H103.41V94H67L95.2179 22Z" fill="currentColor" />
          <path d="M230.218 22H244.782L273 94H255.25L237.045 45.5L225.212 79H238.41V94H202L230.218 22Z" fill="currentColor" />
          <path d="M279 22H290.429L344 94H323.286L295.429 56.4696V94H279V22Z" fill="currentColor" />
          <rect x="327.571" y="22" width="15.7143" height="45.9556" fill="currentColor" />
          <path d="M146.068 93V23.1818H173.614C178.886 23.1818 183.386 24.125 187.114 26.0114C190.864 27.875 193.716 30.5227 195.67 33.9545C197.648 37.3636 198.636 41.375 198.636 45.9886C198.636 50.625 197.636 54.6136 195.636 57.9545C193.636 61.2727 190.739 63.8182 186.943 65.5909C183.17 67.3636 178.602 68.25 173.239 68.25H154.795V56.3864H170.852C173.67 56.3864 176.011 56 177.875 55.2273C179.739 54.4545 181.125 53.2955 182.034 51.75C182.966 50.2045 183.432 48.2841 183.432 45.9886C183.432 43.6705 182.966 41.7159 182.034 40.125C181.125 38.5341 179.727 37.3295 177.841 36.5114C175.977 35.6705 173.625 35.25 170.784 35.25H160.83V93H146.068ZM183.773 61.2273L201.125 93H184.83L167.852 61.2273H183.773Z" fill="currentColor" />
          <path d="M160 35H161L165.714 56.0909H170L162.857 68.1429V93H160V35Z" fill="white" />
        </svg>
      </a>
